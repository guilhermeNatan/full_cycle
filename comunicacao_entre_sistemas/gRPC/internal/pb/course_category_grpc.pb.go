...
type CategoryServiceClient interface {
	...
	CreateCategorySteam(ctx context.Context, opts ...grpc.CallOption) (CategoryService_CreateCategorySteamClient, error)
...
func (c *categoryServiceClient) CreateCategorySteam(ctx context.Context, opts ...grpc.CallOption) (CategoryService_CreateCategorySteamClient, error) {
	stream, err := c.cc.NewStream(ctx, &CategoryService_ServiceDesc.Streams[0], "/pb.CategoryService/CreateCategorySteam", opts...)
	if err != nil {
		return nil, err
	}
	x := &categoryServiceCreateCategorySteamClient{stream}
	return x, nil
}

type CategoryService_CreateCategorySteamClient interface {
	Send(*CreateCategoryRequest) error
	CloseAndRecv() (*CategoryList, error)
	grpc.ClientStream
}

type categoryServiceCreateCategorySteamClient struct {
	grpc.ClientStream
}

func (x *categoryServiceCreateCategorySteamClient) Send(m *CreateCategoryRequest) error {
	return x.ClientStream.SendMsg(m)
}

func (x *categoryServiceCreateCategorySteamClient) CloseAndRecv() (*CategoryList, error) {
...
type CategoryServiceServer interface {
	...
	CreateCategorySteam(CategoryService_CreateCategorySteamServer) error
...
func (UnimplementedCategoryServiceServer) CreateCategorySteam(CategoryService_CreateCategorySteamServer) error {
	return status.Errorf(codes.Unimplemented, "method CreateCategorySteam not implemented")
}
...
func _CategoryService_CreateCategorySteam_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(CategoryServiceServer).CreateCategorySteam(&categoryServiceCreateCategorySteamServer{stream})
}

type CategoryService_CreateCategorySteamServer interface {
	SendAndClose(*CategoryList) error
	Recv() (*CreateCategoryRequest, error)
	grpc.ServerStream
}

type categoryServiceCreateCategorySteamServer struct {
	grpc.ServerStream
}

func (x *categoryServiceCreateCategorySteamServer) SendAndClose(m *CategoryList) error {
	return x.ServerStream.SendMsg(m)
}

func (x *categoryServiceCreateCategorySteamServer) Recv() (*CreateCategoryRequest, error) {
...
var CategoryService_ServiceDesc = grpc.ServiceDesc{
	...
	Streams: []grpc.StreamDesc{
		{
			StreamName:    "CreateCategorySteam",
			Handler:       _CategoryService_CreateCategorySteam_Handler,
			ClientStreams: true,
		},
		{
